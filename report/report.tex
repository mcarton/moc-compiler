...
\section{Génération de code}
  ...
  \paragraph{}
  Il n'y a pas de code spécifique à \llvm{} ou a \tam{} en dehors de leur
  dossier respectif. L'interface \verb+IMachine+ et le \egg{} ont été prévues
  ...
  type, mais aussi son nom en \llvm{} (par exemple le type \verb+Int+ est
  représenté par un \verb+i64+, la constante \verb+"hello"+ par un
  \verb+[6 x i8]+ -- le nom n'ayant de sens qu'avec cette machine) on utilise
  un visiteur.
  ...
  du \textit{C}, il ne fait donc pas parti de l'interface commune. Les
